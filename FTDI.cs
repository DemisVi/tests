#region Assembly FTD2XX_NET, Version=1.1.0.0, Culture=neutral, PublicKeyToken=null
// C:\Users\liudskoi\Desktop\Code\Wrench.Serviceclasses\FTD2XX_NET.dll
...
namespace FTD2XX_NET
{
    ...
    public class FTDI
    {
        ...
        public class FT_BIT_MODES
        {
            ...
            //
            // Summary:
            //     MCU host bus emulation mode - only available on FT2232, FT2232H, FT4232H and
            //     FT232H
            public const byte FT_BIT_MODE_MCU_HOST = 8;

            //
            // Summary:
            //     Fast opto-isolated serial mode - only available on FT2232, FT2232H, FT4232H and
            //     FT232H
            ...
            //
            // Summary:
            //     Single channel synchronous 245 FIFO mode - only available on FT2232H channel
            //     A and FT232H
        ...
        //
        // Summary:
        //     Available functions for the X-Series CBUS pins. Controlled by X-Series EEPROM
        //     settings
        ...
        //
        // Summary:
        //     Type that holds device information for GetDeviceInformation method. Used with
        //     FT_GetDeviceInfo and FT_GetDeviceInfoDetail in FTD2XX.DLL
        public class FT_DEVICE_INFO_NODE
        {
            //
            // Summary:
            //     Indicates device state. Can be any combination of the following: FT_FLAGS_OPENED,
            //     FT_FLAGS_HISPEED
            public uint Flags;
        ...
        public class FT_EEPROM_DATA
        {
            ...
            //
            // Summary:
            //     Manufacturer name abbreviation to be used as a prefix for automatically generated
            //     serial numbers
            ...
            //
            // Summary:
            //     Indicates if the device has its own power supply (self-powered) or gets power
            //     from the USB port (bus-powered)
            public bool SelfPowered;

            //
            // Summary:
            //     Determines if the device can wake the host PC from suspend by toggling the RI
            //     line
        ...
        public class FT232R_EEPROM_STRUCTURE : FT_EEPROM_DATA
        {
            //
            // Summary:
            //     Disables the FT232R internal clock source. If the device has external oscillator
            //     enabled it must have an external oscillator fitted to function
            ...
            //
            // Summary:
            //     Sets the function of the CBUS0 pin for FT232R devices. Valid values are FT_CBUS_TXDEN,
            //     FT_CBUS_PWRON , FT_CBUS_RXLED, FT_CBUS_TXLED, FT_CBUS_TXRXLED, FT_CBUS_SLEEP,
            //     FT_CBUS_CLK48, FT_CBUS_CLK24, FT_CBUS_CLK12, FT_CBUS_CLK6, FT_CBUS_IOMODE, FT_CBUS_BITBANG_WR,
            //     FT_CBUS_BITBANG_RD
            public byte Cbus0 = 5;

            //
            // Summary:
            //     Sets the function of the CBUS1 pin for FT232R devices. Valid values are FT_CBUS_TXDEN,
            //     FT_CBUS_PWRON , FT_CBUS_RXLED, FT_CBUS_TXLED, FT_CBUS_TXRXLED, FT_CBUS_SLEEP,
            //     FT_CBUS_CLK48, FT_CBUS_CLK24, FT_CBUS_CLK12, FT_CBUS_CLK6, FT_CBUS_IOMODE, FT_CBUS_BITBANG_WR,
            //     FT_CBUS_BITBANG_RD
            public byte Cbus1 = 5;
            ...
            //
            // Summary:
            //     Sets the function of the CBUS2 pin for FT232R devices. Valid values are FT_CBUS_TXDEN,
            //     FT_CBUS_PWRON , FT_CBUS_RXLED, FT_CBUS_TXLED, FT_CBUS_TXRXLED, FT_CBUS_SLEEP,
            //     FT_CBUS_CLK48, FT_CBUS_CLK24, FT_CBUS_CLK12, FT_CBUS_CLK6, FT_CBUS_IOMODE, FT_CBUS_BITBANG_WR,
            //     FT_CBUS_BITBANG_RD
            public byte Cbus2 = 5;
            ...
            //
            // Summary:
            //     Sets the function of the CBUS3 pin for FT232R devices. Valid values are FT_CBUS_TXDEN,
            //     FT_CBUS_PWRON , FT_CBUS_RXLED, FT_CBUS_TXLED, FT_CBUS_TXRXLED, FT_CBUS_SLEEP,
            //     FT_CBUS_CLK48, FT_CBUS_CLK24, FT_CBUS_CLK12, FT_CBUS_CLK6, FT_CBUS_IOMODE, FT_CBUS_BITBANG_WR,
            //     FT_CBUS_BITBANG_RD
            public byte Cbus3 = 5;
            ...
            //
            // Summary:
            //     Sets the function of the CBUS4 pin for FT232R devices. Valid values are FT_CBUS_TXDEN,
            //     FT_CBUS_PWRON , FT_CBUS_RXLED, FT_CBUS_TXLED, FT_CBUS_TXRXLED, FT_CBUS_SLEEP,
            //     FT_CBUS_CLK48, FT_CBUS_CLK24, FT_CBUS_CLK12, FT_CBUS_CLK6
            public byte Cbus4 = 5;
        ...
        public class FT2232H_EEPROM_STRUCTURE : FT_EEPROM_DATA
        {
            ...
            //
            // Summary:
            //     For self-powered designs, keeps the FT2232H in low power state until BCBUS7 is
            //     high
        ...
        public class FT232H_EEPROM_STRUCTURE : FT_EEPROM_DATA
        {
            ...
            //
            // Summary:
            //     Sets the function of the CBUS0 pin for FT232H devices. Valid values are FT_CBUS_TRISTATE,
            //     FT_CBUS_RXLED, FT_CBUS_TXLED, FT_CBUS_TXRXLED, FT_CBUS_PWREN, FT_CBUS_SLEEP,
            //     FT_CBUS_DRIVE_0, FT_CBUS_DRIVE_1, FT_CBUS_TXDEN, FT_CBUS_CLK30, FT_CBUS_CLK15,
            //     FT_CBUS_CLK7_5
            public byte Cbus0;

            //
            // Summary:
            //     Sets the function of the CBUS1 pin for FT232H devices. Valid values are FT_CBUS_TRISTATE,
            //     FT_CBUS_RXLED, FT_CBUS_TXLED, FT_CBUS_TXRXLED, FT_CBUS_PWREN, FT_CBUS_SLEEP,
            //     FT_CBUS_DRIVE_0, FT_CBUS_DRIVE_1, FT_CBUS_TXDEN, FT_CBUS_CLK30, FT_CBUS_CLK15,
            //     FT_CBUS_CLK7_5
            public byte Cbus1;
            ...
            //
            // Summary:
            //     Sets the function of the CBUS2 pin for FT232H devices. Valid values are FT_CBUS_TRISTATE,
            //     FT_CBUS_RXLED, FT_CBUS_TXLED, FT_CBUS_TXRXLED, FT_CBUS_PWREN, FT_CBUS_SLEEP,
            //     FT_CBUS_DRIVE_0, FT_CBUS_DRIVE_1, FT_CBUS_TXDEN
            public byte Cbus2;

            //
            // Summary:
            //     Sets the function of the CBUS3 pin for FT232H devices. Valid values are FT_CBUS_TRISTATE,
            //     FT_CBUS_RXLED, FT_CBUS_TXLED, FT_CBUS_TXRXLED, FT_CBUS_PWREN, FT_CBUS_SLEEP,
            //     FT_CBUS_DRIVE_0, FT_CBUS_DRIVE_1, FT_CBUS_TXDEN
            public byte Cbus3;
            ...
            //
            // Summary:
            //     Sets the function of the CBUS4 pin for FT232H devices. Valid values are FT_CBUS_TRISTATE,
            //     FT_CBUS_RXLED, FT_CBUS_TXLED, FT_CBUS_TXRXLED, FT_CBUS_PWREN, FT_CBUS_SLEEP,
            //     FT_CBUS_DRIVE_0, FT_CBUS_DRIVE_1, FT_CBUS_TXDEN
            public byte Cbus4;
            ...
            //
            // Summary:
            //     Sets the function of the CBUS5 pin for FT232H devices. Valid values are FT_CBUS_TRISTATE,
            //     FT_CBUS_RXLED, FT_CBUS_TXLED, FT_CBUS_TXRXLED, FT_CBUS_PWREN, FT_CBUS_SLEEP,
            //     FT_CBUS_DRIVE_0, FT_CBUS_DRIVE_1, FT_CBUS_IOMODE, FT_CBUS_TXDEN, FT_CBUS_CLK30,
            //     FT_CBUS_CLK15, FT_CBUS_CLK7_5
            public byte Cbus5;

            //
            // Summary:
            //     Sets the function of the CBUS6 pin for FT232H devices. Valid values are FT_CBUS_TRISTATE,
            //     FT_CBUS_RXLED, FT_CBUS_TXLED, FT_CBUS_TXRXLED, FT_CBUS_PWREN, FT_CBUS_SLEEP,
            //     FT_CBUS_DRIVE_0, FT_CBUS_DRIVE_1, FT_CBUS_IOMODE, FT_CBUS_TXDEN, FT_CBUS_CLK30,
            //     FT_CBUS_CLK15, FT_CBUS_CLK7_5
            public byte Cbus6;
            ...
            //
            // Summary:
            //     Sets the function of the CBUS8 pin for FT232H devices. Valid values are FT_CBUS_TRISTATE,
            //     FT_CBUS_RXLED, FT_CBUS_TXLED, FT_CBUS_TXRXLED, FT_CBUS_PWREN, FT_CBUS_SLEEP,
            //     FT_CBUS_DRIVE_0, FT_CBUS_DRIVE_1, FT_CBUS_IOMODE, FT_CBUS_TXDEN, FT_CBUS_CLK30,
            //     FT_CBUS_CLK15, FT_CBUS_CLK7_5
            public byte Cbus8;
            ...
            //
            // Summary:
            //     Sets the function of the CBUS9 pin for FT232H devices. Valid values are FT_CBUS_TRISTATE,
            //     FT_CBUS_RXLED, FT_CBUS_TXLED, FT_CBUS_TXRXLED, FT_CBUS_PWREN, FT_CBUS_SLEEP,
            //     FT_CBUS_DRIVE_0, FT_CBUS_DRIVE_1, FT_CBUS_IOMODE, FT_CBUS_TXDEN, FT_CBUS_CLK30,
            //     FT_CBUS_CLK15, FT_CBUS_CLK7_5
            public byte Cbus9;
            ...
            //
            // Summary:
            //     For self-powered designs, keeps the FT232H in low power state until ACBUS7 is
            //     high
            public bool PowerSaveEnable;
        }
        ...
        public class FT_XSERIES_EEPROM_STRUCTURE : FT_EEPROM_DATA
        {
            ...
            //     Sets the function of the CBUS0 pin for FT232H devices. Valid values are FT_CBUS_TRISTATE,
            //     FT_CBUS_RXLED, FT_CBUS_TXLED, FT_CBUS_TXRXLED, FT_CBUS_PWREN, FT_CBUS_SLEEP,
            //     FT_CBUS_DRIVE_0, FT_CBUS_DRIVE_1, FT_CBUS_GPIO, FT_CBUS_TXDEN, FT_CBUS_CLK24,
            //     FT_CBUS_CLK12, FT_CBUS_CLK6, FT_CBUS_BCD_CHARGER, FT_CBUS_BCD_CHARGER_N, FT_CBUS_VBUS_SENSE,
            //     FT_CBUS_BITBANG_WR, FT_CBUS_BITBANG_RD, FT_CBUS_TIME_STAMP, FT_CBUS_KEEP_AWAKE
            public byte Cbus0;
            ...
            //     Sets the function of the CBUS4 pin for FT232H devices. Valid values are FT_CBUS_TRISTATE,
            //     FT_CBUS_RXLED, FT_CBUS_TXLED, FT_CBUS_TXRXLED, FT_CBUS_PWREN, FT_CBUS_SLEEP,
            //     FT_CBUS_DRIVE_0, FT_CBUS_DRIVE_1, FT_CBUS_TXDEN, FT_CBUS_CLK24, FT_CBUS_CLK12,
            //     FT_CBUS_CLK6, FT_CBUS_BCD_CHARGER, FT_CBUS_BCD_CHARGER_N, FT_CBUS_VBUS_SENSE,
            //     FT_CBUS_BITBANG_WR, FT_CBUS_BITBANG_RD, FT_CBUS_TIME_STAMP, FT_CBUS_KEEP_AWAKE
            public byte Cbus4;
        ...
        //
        // Summary:
        //     Built-in Windows API functions to allow us to dynamically load our own DLL. Will
        //     allow us to use old versions of the DLL that do not have all of these functions
        //     available.
        ...
        // Parameters:
        //   devicelist:
        //     An array of type FT_DEVICE_INFO_NODE to contain the device information for all
        //     available devices.
        //
        // Returns:
        ...
        //
        // Exceptions:
        //   T:FTD2XX_NET.FTDI.FT_EXCEPTION:
        //     Thrown when the supplied buffer is not large enough to contain the device info
        //     list.
        ...
        // Parameters:
        //   index:
        //     Index of the device to open. Note that this cannot be guaranteed to open a specific
        //     device.
        //
        // Returns:
        ...
        //
        // Remarks:
        //     Initialises the device to 8 data bits, 1 stop bit, no parity, no flow control
        //     and 9600 Baud.
        ...
        // Parameters:
        //   description:
        //     Description of the device to open.
        //
        // Returns:
        //     FT_STATUS value from FT_OpenEx in FTD2XX.DLL
        //
        ...
        // Parameters:
        //   location:
        //     Location of the device to open.
        //
        // Returns:
        //     FT_STATUS value from FT_OpenEx in FTD2XX.DLL
        //
        ...
        // Parameters:
        //   dataBuffer:
        //     An array of bytes which contains the data to be written to the device.
        //
        //   numBytesToWrite:
        ...
        // Parameters:
        //   dataBuffer:
        //     A string which contains the data to be written to the device.
        //
        //   numBytesToWrite:
        //     The number of bytes to be written to the device.
        //
        ...
        // Parameters:
        //   purgemask:
        //     Specifies which buffer(s) to be purged. Valid values are any combination of the
        //     following flags: FT_PURGE_RX, FT_PURGE_TX
        //
        // Returns:
        ...
        //
        //   eventhandle:
        //     Handle to the event that will receive the notification
        //
        // Returns:
        //     FT_STATUS value from FT_SetEventNotification in FTD2XX.DLL
        //
        // Remarks:
        //     After setting event notification, the event can be caught by executing the WaitOne()
        //     method of the EventWaitHandle. If multiple event types are being monitored, the
        //     event that fired can be determined from the GetEventType method.
        ...
        //
        // Summary:
        //     Causes the device to be re-enumerated on the USB bus. This is equivalent to unplugging
        //     and replugging the device. Also calls FT_Close if FT_CyclePort is successful,
        //     so no need to call this separately in the application.
        //
        // Returns:
        ...
        //
        // Summary:
        //     Causes the system to check for USB hardware changes. This is equivalent to clicking
        //     on the "Scan for hardware changes" button in the Device Manager.
        //
        // Returns:
        ...
        //
        // Remarks:
        //     If the VID and PID parameters are 0, the drivers for USB root hubs will be reloaded,
        //     causing all USB devices connected to reload their drivers
        ...
        // Parameters:
        //   Mask:
        //     Sets up which bits are inputs and which are outputs. A bit value of 0 sets the
        //     corresponding pin to an input, a bit value of 1 sets the corresponding pin to
        //     an output. In the case of CBUS Bit Bang, the upper nibble of this value controls
        //     which pins are inputs and outputs, while the lower nibble controls which of the
        //     outputs are high and low.
        //
        //   BitMode:
        //     For FT232H devices, valid values are FT_BIT_MODE_RESET, FT_BIT_MODE_ASYNC_BITBANG,
        //     FT_BIT_MODE_MPSSE, FT_BIT_MODE_SYNC_BITBANG, FT_BIT_MODE_CBUS_BITBANG, FT_BIT_MODE_MCU_HOST,
        //     FT_BIT_MODE_FAST_SERIAL, FT_BIT_MODE_SYNC_FIFO. For FT2232H devices, valid values
        //     are FT_BIT_MODE_RESET, FT_BIT_MODE_ASYNC_BITBANG, FT_BIT_MODE_MPSSE, FT_BIT_MODE_SYNC_BITBANG,
        //     FT_BIT_MODE_MCU_HOST, FT_BIT_MODE_FAST_SERIAL, FT_BIT_MODE_SYNC_FIFO. For FT4232H
        //     devices, valid values are FT_BIT_MODE_RESET, FT_BIT_MODE_ASYNC_BITBANG, FT_BIT_MODE_MPSSE,
        //     FT_BIT_MODE_SYNC_BITBANG. For FT232R devices, valid values are FT_BIT_MODE_RESET,
        //     FT_BIT_MODE_ASYNC_BITBANG, FT_BIT_MODE_SYNC_BITBANG, FT_BIT_MODE_CBUS_BITBANG.
        //     For FT245R devices, valid values are FT_BIT_MODE_RESET, FT_BIT_MODE_ASYNC_BITBANG,
        //     FT_BIT_MODE_SYNC_BITBANG. For FT2232 devices, valid values are FT_BIT_MODE_RESET,
        //     FT_BIT_MODE_ASYNC_BITBANG, FT_BIT_MODE_MPSSE, FT_BIT_MODE_SYNC_BITBANG, FT_BIT_MODE_MCU_HOST,
        //     FT_BIT_MODE_FAST_SERIAL. For FT232B and FT245B devices, valid values are FT_BIT_MODE_RESET,
        ...
        public FT_STATUS SetBitMode(byte Mask, byte BitMode)
        {
            ...
            if (pFT_SetBitMode != IntPtr.Zero)
            {
                ...
                if (ftHandle != IntPtr.Zero)
                {
                    ...
                    else if (DeviceType == FT_DEVICE.FT_DEVICE_232H && BitMode != 0 && BitMode > 64)
                    {
                        fT_ERROR = FT_ERROR.FT_INVALID_BITMODE;
                        ErrorHandler(fT_STATUS, fT_ERROR);
                    }
        ...
        // Parameters:
        //   Address:
        //     The EEPROM location to read data from
        //
        //   EEValue:
        ...
        //
        //   EEValue:
        //     The WORD value to write to the EEPROM location specified by the Address parameter
        //
        // Returns:
        ...
        // Exceptions:
        //   T:FTD2XX_NET.FTDI.FT_EXCEPTION:
        //     Thrown when attempting to erase the EEPROM of a device with an internal EEPROM
        //     such as an FT232R or FT245R.
        ...
        // Parameters:
        //   ee232b:
        //     An FT232B_EEPROM_STRUCTURE which contains only the relevant information for an
        //     FT232B and FT245B device.
        //
        // Returns:
        ...
        // Parameters:
        //   ee2232:
        //     An FT2232_EEPROM_STRUCTURE which contains only the relevant information for an
        //     FT2232 device.
        //
        // Returns:
        //     FT_STATUS value from FT_EE_Read in FTD2XX DLL
        ...
        //
        // Summary:
        //     Reads the EEPROM contents of an FT232R or FT245R device. Calls FT_EE_Read in
        //     FTD2XX DLL
        //
        // Returns:
        //     An FT232R_EEPROM_STRUCTURE which contains only the relevant information for an
        //     FT232R and FT245R device.
        //
        // Exceptions:
        //   T:FTD2XX_NET.FTDI.FT_EXCEPTION:
        //     Thrown when the current device does not match the type required by this method.
        ...
        // Parameters:
        //   ee2232h:
        //     An FT2232H_EEPROM_STRUCTURE which contains only the relevant information for
        //     an FT2232H device.
        //
        // Returns:
        //     FT_STATUS value from FT_EE_Read in FTD2XX DLL
        ...
        // Parameters:
        //   ee4232h:
        //     An FT4232H_EEPROM_STRUCTURE which contains only the relevant information for
        //     an FT4232H device.
        //
        // Returns:
        //     FT_STATUS value from FT_EE_Read in FTD2XX DLL
        ...
        // Parameters:
        //   ee232h:
        //     An FT232H_EEPROM_STRUCTURE which contains only the relevant information for an
        //     FT232H device.
        //
        // Returns:
        //     FT_STATUS value from FT_EE_Read in FTD2XX DLL
        ...
        // Parameters:
        //   eeX:
        //     An FT_XSERIES_EEPROM_STRUCTURE which contains only the relevant information for
        //     an X-Series device.
        //
        // Returns:
        ...
        // Parameters:
        //   ee232b:
        //     The EEPROM settings to be written to the device
        //
        // Returns:
        ...
        //
        // Remarks:
        //     If the strings are too long, they will be truncated to their maximum permitted
        //     lengths
        ...
        //
        // Summary:
        //     Writes the specified values to the EEPROM of an FT2232 device. Calls FT_EE_Program
        //     in FTD2XX DLL
        //
        // Parameters:
        //   ee2232:
        ...
        //
        // Summary:
        //     Writes the specified values to the EEPROM of an FT232R or FT245R device. Calls
        //     FT_EE_Program in FTD2XX DLL
        //
        // Parameters:
        //   ee232r:
        //     The EEPROM settings to be written to the device
        ...
        //
        // Summary:
        //     Writes the specified values to the EEPROM of an FT2232H device. Calls FT_EE_Program
        //     in FTD2XX DLL
        //
        // Parameters:
        //   ee2232h:
        ...
        //
        // Summary:
        //     Writes the specified values to the EEPROM of an FT4232H device. Calls FT_EE_Program
        //     in FTD2XX DLL
        //
        // Parameters:
        //   ee4232h:
        ...
        //
        // Summary:
        //     Writes the specified values to the EEPROM of an FT232H device. Calls FT_EE_Program
        //     in FTD2XX DLL
        //
        // Parameters:
        //   ee232h:
        ...
        //
        // Summary:
        //     Writes the specified values to the EEPROM of an X-Series device. Calls FT_EEPROM_Program
        //     in FTD2XX DLL
        //
        // Parameters:
        //   eeX:
        ...
        // Parameters:
        //   UserAreaDataBuffer:
        //     An array of bytes which will be written to the device EEPROM user area.
        //
        // Returns:
        ...
        //
        // Summary:
        //     Gets the event type after an event has fired. Can be used to distinguish which
        //     event has been triggered when waiting on multiple event types.
        //
        // Parameters:
        //   EventType:
        ...
        // Parameters:
        //   BaudRate:
        //     The desired Baud rate for the device.
        //
        // Returns:
        ...
        // Parameters:
        //   DataBits:
        //     The number of data bits for UART data. Valid values are FT_DATA_BITS.FT_DATA_7
        //     or FT_DATA_BITS.FT_BITS_8
        //
        //   StopBits:
        //     The number of stop bits for UART data. Valid values are FT_STOP_BITS.FT_STOP_BITS_1
        ...
        //
        //   Xon:
        //     The Xon character for Xon/Xoff flow control. Ignored if not using Xon/XOff flow
        //     control.
        //
        //   Xoff:
        //     The Xoff character for Xon/Xoff flow control. Ignored if not using Xon/XOff flow
        //     control.
        //
        // Returns:
        ...
        // Parameters:
        //   Enable:
        //     If true, asserts RTS. If false, de-asserts RTS
        //
        // Returns:
        ...
        // Parameters:
        //   Enable:
        //     If true, asserts DTR. If false, de-asserts DTR.
        //
        // Returns:
        ...
        // Parameters:
        //   ReadTimeout:
        //     Read timeout value in ms. A value of 0 indicates an infinite timeout.
        //
        //   WriteTimeout:
        //     Write timeout value in ms. A value of 0 indicates an infinite timeout.
        //
        // Returns:
        ...
        // Parameters:
        //   Enable:
        //     If true, sets break on. If false, sets break off.
        //
        // Returns:
        ...
        // Parameters:
        //   ResetPipeRetryCount:
        //     The reset pipe retry count. Electrically noisy environments may benefit from
        //     a larger value.
        //
        // Returns:
        ...
        // Parameters:
        //   DeadmanTimeout:
        //     The deadman timeout value in ms. Default is 5000ms.
        //
        // Returns:
        ...
        // Parameters:
        //   Latency:
        //     The latency timer value in ms. Valid values are 2ms - 255ms for FT232BM, FT245BM
        //     and FT2232 devices. Valid values are 0ms - 255ms for other devices.
        //
        // Returns:
        ...
        // Parameters:
        //   InTransferSize:
        //     The USB IN transfer size in bytes.
        //
        // Returns:
        ...
        // Parameters:
        //   EventChar:
        //     A character that will be tigger an IN to the host when this character is received.
        //
        //   EventCharEnable:
        //     Determines if the EventChar is enabled or disabled.
        //
        //   ErrorChar:
        //     A character that will be inserted into the data stream to indicate that an error
        //     has occurred.
        //
        //   ErrorCharEnable:
        //     Determines if the ErrorChar is enabled or disabled.
        //
        // Returns:
        ...
        //
        // Summary:
        //     Gets the corresponding COM port number for the current device. If no COM port
        //     is exposed, an empty string is returned.
        //
        // Parameters:
        //   ComPortName:
        //     The COM port name corresponding to the current device. If no COM port is installed,
        ...
        //
        // Summary:
        //     Method to check ftStatus and ftErrorCondition values for error conditions and
...
Load from: 'C:\Program Files\dotnet\packs\Microsoft.NETCore.App.Ref\6.0.11\ref\net6.0\mscorlib.dll'
------------------
